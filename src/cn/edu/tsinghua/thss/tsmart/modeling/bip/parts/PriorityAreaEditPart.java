...
import cn.edu.tsinghua.thss.tsmart.modeling.bip.policies.PriorityAreaChildEditPolicy;
 ...
 * 
 */
public class PriorityAreaEditPart extends BaseGraphicalEditPart {
    ...
    protected List getModelChildren() {
        return ((PriorityAreaModel) getModel()).getChildren();
    }

    @Override
    protected void refreshVisuals() {
        PriorityAreaModel model = (PriorityAreaModel) getModel();
        ...
        if (model.isShow()) {
            ...
            for (Object child : getChildren()) {
                if (child instanceof PriorityEditPart) {
                    PriorityEditPart item = (PriorityEditPart) child;
    ...
    protected void createEditPolicies() {
        installEditPolicy(EditPolicy.LAYOUT_ROLE, new PriorityAreaChildEditPolicy());
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (PriorityAreaModel.CHILDREN.equals(evt.getPropertyName())) {
            refresh();
        } else if (PriorityAreaModel.CONSTRAINT.equals(evt.getPropertyName())) {
    ...
    protected void registerVisuals() {
        ...
        Rectangle rect = ((PriorityAreaModel) getModel()).getPositionConstraint();
