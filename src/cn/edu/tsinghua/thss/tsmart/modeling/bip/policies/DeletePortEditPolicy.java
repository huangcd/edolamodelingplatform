...
import cn.edu.tsinghua.thss.tsmart.modeling.bip.commands.DeletePortCommand;
...
public class DeletePortEditPolicy extends ComponentEditPolicy {
    @Override
    protected Command createDeleteCommand(GroupRequest deleteRequest) {
        DeletePortCommand command = new DeletePortCommand();
        command.setParent((PortAreaModel) getHost().getParent().getModel());
        command.setChild((PortModel) getHost().getModel());
        return command;
    }
}
